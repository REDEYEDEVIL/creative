                                    ...
                                    <div class="row">
                                        <div class="col-md-6 ">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="preschoolTitle"
                                                    id="preschoolTitle" value=""
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="preschoolImages" class="form-label">Multiple Images<span
                                                        class="text-danger">*</span></label>
                                                <input class="form-control" type="file" name="preschoolImages[]"
                                                    id="preschoolImages" multiple>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
