<?php
include('include/middleschool.php');
?>
<!DOCTYPE html>
<html lang="en">

<head>
    <title>Middleschool</title>
        ...
        <div class="p-3" style="height: 100vh !important; width: 100%;">
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-dark"><strong>Middleschool</strong></h5>

                            <form method="post" id="aboutForm" role="form" enctype="multipart/form-data"
                                style="border-top: 1px solid #cfcfcf;">
                                <div class="card-body p-1 mt-2">
                                    <!-- middleschool Section -->

                                    <div class="row">
                                        <div class="col-md-6 ">
                                            <div class="form-group">
                                                <label for="middleschoolTitle" class="text-dark-50">Middleschool
                                                    Title<span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="middleschoolTitle"
                                                    id="middleschoolTitle" value=""
                                                    placeholder="Enter middleschool Title. . . . .">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="middleschoolImages" class="form-label">Multiple Images<span
                                                        class="text-danger">*</span></label>
                                                <input class="form-control" type="file" name="middleschoolImages[]"
                                                    id="middleschoolImages" multiple>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="text-dark" style="border-bottom: 1px solid #cfcfcf;padding-bottom:5px ; ">
                                <strong>middleschool List (<span id="roleCount"><?php echo $x; ?></span>)</strong>
                            </h5>
