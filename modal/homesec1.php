<?php
include('include/homesec1.php');
?>
<!DOCTYPE html>
<html lang="en">

<head>
    <title>homesec1</title>
...
<body>
        ...
        <div class="p-3" style="height: 100vh !important; width: 100%;">
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-dark"><strong>Home section 1</strong></h5>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 ">
                                            <div class="form-group">
                                                <label for="homesec1Title" class="text-dark-50">Title
                                                    <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="homesec1Title"
                                                    id="homesec1Title" value=""
                                                    placeholder="Enter Home section 1 Title. . . . .">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="homesec1Images" class="form-label">Multiple Images<span
                                                        class="text-danger">*</span></label>
                                                <input class="form-control" type="file" name="homesec1Images[]"
                                                    id="homesec1Images" multiple>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="text-dark" style="border-bottom: 1px solid #cfcfcf;padding-bottom:5px ; ">
                                <strong>Home section 1 List (<span id="roleCount"><?php echo $x; ?></span>)</strong>
                            </h5>
    ...
    <!-- CKEditor Initialization -->
    <script>
        CKEDITOR.replace('homesec1Description');
    </script>