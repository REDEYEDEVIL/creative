...
<body>
        ...
        <div class="p-3" style="height: 100vh !important; width: 100%;">
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-dark"><strong>Activities</strong></h5>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 ">
                                            <div class="form-group">
                                                <label for="activitiesTitle" class="text-dark-50">Title
                                                    <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="activitiesTitle"
                                                    id="activitiesTitle" value=""
                                                    placeholder="Enter Activities Title. . . . .">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="activitiesImages" class="form-label">Image<span
                                                        class="text-danger">*</span></label>
                                                <input class="form-control" type="file" name="activitiesImages[]"
                                                    id="activitiesImages">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="text-dark" style="border-bottom: 1px solid #cfcfcf;padding-bottom:5px ; ">
                                <strong>activities List (<span id="roleCount"><?php echo $x; ?></span>)</strong>
                            </h5>
    ...
    <!-- CKEditor Initialization -->
    <script>
        CKEDITOR.replace('activitiesDescription');
    </script>