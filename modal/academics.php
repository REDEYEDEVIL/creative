  ...
  <div class="p-3" style="height: 100vh !important; width: 100%;">
    <div class="row">
      <div class="col-md-6">
        <div class="card">
          <div class="card-body">
            <h5 class="text-dark"><strong>Academics</strong></h5>
            ...
            <form method="post" id="aboutForm" role="form" enctype="multipart/form-data"
              ...
              <div class="card-body p-1 mt-2">
                ...
                <div class="row">
                  <div class="col-md-6 ">
                    <div class="form-group">
                      <label for="academicsTitle" class="text-dark-50">Academics Title<span
                          class="text-danger">*</span></label>
                      <input type="text" class="form-control" name="academicsTitle" id="academicsTitle" value=""
                        placeholder="Enter academics Title. . . . .">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="academicsImages" class="form-label">Upload Image<span
                          class="text-danger">*</span></label>
                      <input  class="form-control" type="file" name="academicsImages[]" id="academicsImages">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" placeholder="" id="ckeditor" name="academicsdescription"
                        rows="10"></textarea>
                    </div>
                  </div>
                </div>
                <div class="form-group row mr-1 justify-content-end">
                  ...
                  <a href="academics.php" name="cancel" class=" col-2 ml-1 btn btn-danger">Cancel</a>
                </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <h5 class="text-dark" style="border-bottom: 1px solid #cfcfcf;padding-bottom:5px ; ">
              <strong>Academics List (<span id="roleCount"><?php echo $x; ?></span>)</strong>
            </h5>
