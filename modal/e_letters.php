                                ...
                                <div class="row">
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="letterName" id="letterName"
                                                value="<?php echo $letterName; ?>" placeholder="Enter  Title. . . . ." required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-controlfile" type="file" name="file" id="name" value="">
                                            <?php
                                            if ($filepath != '') {
